...
void __init msm8960_init_hdmi(struct platform_device *hdmi_dev)
{
	hdmi_dev->dev.platform_data = &hdmi_msm_data;
}
#else
void __init msm8960_init_hdmi(struct platform_device *hdmi_dev) {}
#endif /* CONFIG_FB_MSM_HDMI_MSM_PANEL */
...
void __init msm8960_init_fb(int (*detect_client)(const char *name))
{
